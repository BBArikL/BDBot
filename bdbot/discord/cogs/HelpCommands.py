...
class HelpCommands(commands.Cog):
    ...
    async def schedule(self, inter: discord.Interaction):
        ...
        schedule_embed: Embed = Embed(title="")
        embed = discord.Embed(
    ...
    async def gocomics(self, inter: discord.Interaction):
        """Gocomics help"""
        await discord_utils.send_embed(inter, Gocomics.get_website_help_embed())

    @help_group.command()
    async def comicskingdom(self, inter: discord.Interaction):
        """Comics Kingdom help"""
        await discord_utils.send_embed(inter, ComicsKingdom.get_website_help_embed())

    @help_group.command()
    async def webtoons(self, inter: discord.Interaction):
        """Webtoons help"""
        await discord_utils.send_embed(inter, Webtoons.get_website_help_embed())
